...
export default function StickyCartBar({ cartCount, cartTotal, targetRef }: StickyCartBarProps) {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-8 z-40 bg-slate-900 text-white p-3 md:px-6 rounded-2xl shadow-2xl flex items-center justify-between gap-4 border border-slate-700 animate-in slide-in-from-bottom-5">
